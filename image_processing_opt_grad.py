...
# -----------------------------
def process_image(image_path, image_file, save_folder, segmentation_method='yolo', skip_preprocessing=False, n_clusters=3, optimize_params=False):
    '''
    ...
    if skip_preprocessing:
        ...
        '''
        if optimize_params:
            # Preprocess with optional optimization
            img_normalized = preprocess_with_optimization(img_rgb, optimize=optimize_params)
        else:
...
def process_patient(patient_id, base_path, save_base_path, segmentation_method='yolo', skip_preprocessing=False, n_clusters=3, optimize_params=False):
    '''
    ...
    for image_file in image_files:
        ...
        process_image(image_path, image_file, save_folder, 
                     ...
                     n_clusters=n_clusters, optimize_params=optimize_params)
